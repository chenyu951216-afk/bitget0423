...
def _build_messages(candidate: Dict[str, Any], *, compact: bool = False) -> list[Dict[str, Any]]:
    ...
    if compact:
        ...
        user_text = (
            ...
            'If the symbol is BTC or ETH, treat it as a lower-volatility major: keep the leverage at the symbol maximum in the payload and preserve at least the payload notional size instead of shrinking it to a small altcoin-sized trade.\n'
        ...
        user_text = (
            ...
            'If the symbol is BTC or ETH, keep the order sizing aggressive for a lower-volatility major: use the symbol-max leverage already provided and do not reduce the payload notional below the configured major-coin size.\n'
...
def _fallback_trade_decision(candidate: Dict[str, Any], *, reason: str = '') -> Dict[str, Any]:
    ...
    return {
        ...
        'stop_loss_reason': '失效價放在 15m 最近有意義的高低點外側並保留小緩衝，避免一般噪音掃掉，但也不會放得過遠。',
