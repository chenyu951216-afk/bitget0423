...
def _build_messages(
    ...
    *,
    ...
    system_text = (
        ...
        'Before ENTER, compare candidate with current held_symbols in payload: if structure/flow regime is highly similar to an already-held symbol, SKIP to avoid duplicate exposure. '
    ...
    user_text = (
        ...
        'Use portfolio.held_symbols as current holdings universe. If this candidate is highly similar in trend/structure/flow to any held symbol, do not open a second highly similar position; output SKIP with reason_to_skip explaining which held symbol overlaps.\n'
