...
def _build_messages(
    ...
    *,
    ...
    system_text = (
        ...
        'Use full candidate payload data exactly as provided; do not ignore timeframe bars or flow/liquidity derivatives fields. '
        ...
        'Decision policy: RR/PnL first, accuracy second; aggressive but never random and never chase. '
        'Counter-trend is allowed only with clear rejection/reclaim + flow turn + executable invalidation. '
    ...
    user_text = (
        ...
        'HTF bias is guidance not veto. Use full payload and full timeframe bars for structure + flow judgment.\n'
        'Pick best executable edge now: continuation pullback, reversal reclaim, or pre-breakout release.\n'
