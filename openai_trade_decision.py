...
def build_candidate_payload(
    *,
    ...
    return {
        ...
        'strategy_lane': 'countertrend_reversal' if str(signal.get('candidate_source') or '').lower() == 'short_gainers' else 'trend_following_execution',
...
def _build_messages(
    ...
    *,
    ...
    if not strategy_lane:
        strategy_lane = 'countertrend_reversal' if candidate_source == 'short_gainers' else 'trend_following_execution'
    lane_instruction = (
        ...
        else 'Source lane: general leaderboard trend-following mode. Follow direction, but never chase late extension; '
    ...
    if compact:
        ...
        user_text = (
            ...
            'The stop_loss buffer must explicitly reference 15m ATR volatility in your reasoning (e.g., a small fraction of ATR as anti-sweep space).\n'
