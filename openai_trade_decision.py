...
def _build_messages(
    ...
    *,
    ...
    system_text = (
        ...
        'For fast-moving/high-volatility symbols, avoid overly tight stops that are easily swept: prefer structure-outside invalidation beyond nearby liquidity sweep zones. '
        'When entry is momentum/chasing, stop can be wider (advisory) and position size can be reduced to keep total risk controlled. '
