            ...
            if pos_cnt < MAX_OPEN_POSITIONS:
                ...
                for rank_index, best in enumerate(top10_for_order):
                    ...
                    if openai_mode_active:
                        ...
                        has_short_gainer_slot = openai_short_gainers_this_scan < OPENAI_SHORT_GAINERS_MAX_PER_SCAN
                        has_regular_slot = openai_sent_this_scan < openai_sends_per_scan
                        ...
                        if openai_pending_triggered:
                            source_slot_ok = has_short_gainer_slot if is_short_gainer_review else has_pending_slot
                        else:
