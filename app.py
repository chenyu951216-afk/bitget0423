...
def choose_review_candidates(general_top: List[Dict[str, Any]], short_gainers: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
...
def maybe_run_openai(general_top: List[Dict[str, Any]], short_gainers: List[Dict[str, Any]]) -> None:
    global OPENAI_TRADE_STATE
    reviewed_candidates = choose_review_candidates(general_top, short_gainers)
