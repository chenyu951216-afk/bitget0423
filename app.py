...
SCAN_SYMBOL_LIMIT = max(8, min(120, int(float(env_or_blank("SCAN_SYMBOL_LIMIT", "70") or 70))))
...
def perform_scan_cycle() -> None:
    ...
    try:
        ...
        send_round_limit = max(int(OPENAI_TRADE_CONFIG.get("sends_per_scan", 1) or 1), len(cycle_symbol_pool), 1)
